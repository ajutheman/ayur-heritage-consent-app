...
class colorTheames {
  ...
  static Color fontcolor = const Color.fromARGB(217, 0, 0, 0);
  static Color logincontainercolor =const  Color.fromARGB(255, 255, 255, 255);
  static Color headerbackground = const Color.fromARGB(255, 28, 41, 101);
  static Color selectcatogorybackground =const Color.fromARGB(255, 246, 246, 246);
  static Color changeplanbuttoncolor =const Color.fromARGB(255, 106, 220, 204);
